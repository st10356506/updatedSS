...
//check if all fields are filled
            ...
            if (!isValidPassword(password)) {
                passwordEditText.error = "Password must be at least 6 characters, include an uppercase, lowercase, special character and a number" // OWASP Foundation (2022). Password Policy Guidelines. Available at: https://owasp.org/www-community/password-special-requirements
                return@setOnClickListener
            }
